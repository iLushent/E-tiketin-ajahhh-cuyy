    ...
    <div class="flex font-['Poppins']">
            ...
            <nav class="mt-6  h-full flex flex-col">
                <div class="h-full">
                    ...
                    <a href="./user/user.php"
                        class="block m-1 py-2 px-2 text-white hover:text-gray-50 hover:bg-indigo-800 bg-indigo-600 rounded-md">User</a>
                </div>
                <div class="">
                    <a href="/logout"
        ...
        <div class="flex-auto overflow-x-hidden bg-blue-100">
            <div class="p-6">
                ...
                <div>
                    <a href="./tambahuser.php" class="bg-indigo-500 px-4 py-2 rounded-lg">Tambah Produk</a>
                </div>
                ...
                <table class="min-w-full border-collapse bg-white border border-gray-300 rounded-lg mt-6">
                    ...
                    <?php foreach($pengguna as $data) : ?>
                            ...
                            <tr>
                                ...
                                <td class="flex  py-2px-2 border-b justify-around">
                                    <a href="edituser.php?id=<?= $data["id_user"]; ?>"
                                        class="fa-solid fa-pen-to-square text-md bg-indigo-500 text-white py-2 px-4 hover:text-black rounded-md"></i>Edit</a>
                                    <form action="hapususer.php?id=<?= $data["id_user"]; ?>" class=" inline-block" method="post">
                                        <button type="submit"
